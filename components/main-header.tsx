    ...
    <header className="w-full bg-background  border-b px-4 py-3 flex items-center justify-between">
      <Link href="/" className="flex items-center">
        <div className="flex " aria-label="Logo">
          ...
          <Image src="/LogoAndTextForDarkMode.svg" alt="Logo" width={100} height={50} className="hidden dark:block items-center aspect-auto mx-4" />
          <Image src="/LogoAndTextForWhiteMode.svg" alt="Logo" width={100} height={50} className="block dark:hidden items-center aspect-auto mx-4" />
        </div>
